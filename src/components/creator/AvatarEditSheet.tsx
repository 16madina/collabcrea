        ...
        <div className="flex flex-col items-center gap-6 py-8">
          ...
          >
            <div
              ...
              className="w-40 h-40 rounded-full bg-muted border-2 border-dashed border-border hover:border-gold transition-colors cursor-pointer overflow-hidden flex items-center justify-center"
            >
              {displayImage ? (
                <img
                  src={displayImage}
...
export default AvatarEditSheet;
